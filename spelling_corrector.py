# Step-----1------Install the necessary modules------------done
...
heading_text=Label(app,text="Welcome to Spell Checcker and Corrector App",font='Arial 16 bold',fg='yellow',bg='black')
